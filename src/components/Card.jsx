...
function Card(props) {
    ...
    return (
        ...
        <div className="flex flex-col justify-between p-6 rounded-lg border bg-[#131a26] text-white border-borderdark group-[.app]/light:bg-white group-[.app]/light:text-black group-[.app]/light:border-borderlight ">
